...
concat_hidden_states = Bidirectional(LSTM(64, return_sequences=True), merge_mode='concat')(x)
#calculate attention probs


x = Dropout(0.5)(x) #what proportion of inputs to set to 0
predictions = Dense(1, activation='sigmoid')(x) #single sigmoidal output, predicting either 0 or 1, negative or positive sentiment
